...
class Address {
  ...
  @override
  String toString() {
    return 'Address(uid: $uid, address1: $address1, address2: $address2, city: $city, state: $state, country: $country, pincode: $pincode)';
  }
...
class User {
  ...
  static User fromMap(Map<String, dynamic> map) {
    ...
    return User(
      ...
      fname: map['fname'],
      email: map['email'],
      addresses: List<Address>.from(map['addresses']?.map((x) => Address.fromMap(x))),
    );
  }
